...
const Collaborator = props => {
    ...
    const { isOpen: isCollaboratorOpen, onOpen: onCollaboratorOpen, onClose: onCollaboratorClose } = useDisclosure()
        ...
        <>
            <ListItem
              ...
              >
                ...
                <Drawer onClose={onCollaboratorClose} isOpen={isCollaboratorOpen} size='xl'>
